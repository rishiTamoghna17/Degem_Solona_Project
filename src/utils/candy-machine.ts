...
// import { COLLECTION_1, COLLECTION_2, COLLECTION_3 } from "../consts/contract";
import { COLLECTION } from "../consts/contract";
  ...
  for (let index = 0; index < tokenAccounts.value.length; index++) {
    try{
      ...
      if (tokenAmount.amount === "1" && tokenAmount.decimals === 0) {
        ...
        if (metadata.data.data.creators[0].address === COLLECTION) {
